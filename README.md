...
1. 安装 Java 17 及以上版本。
2. 安装 MySQL 数据库，并创建名为 `english_word_database` 的数据库。
...
1. 安装 Node.js 和 npm。
2. 全局安装 HBuilderX 或使用命令行工具安装 uni-app 脚手架：
...
1. 进入 `remember-words-uniapp` 目录，安装依赖：
...
1. 在 GitHub 上创建一个 Pull Request，描述你的修改内容。
...
- Email: [1175235190@qq.com](mailto:your-email@example.com)
